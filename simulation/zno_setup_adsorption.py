...
# Load the ZnO nanoparticle
np_particle = read('zno_nanoparticle.xyz')
...
write('zno_adsorption_system.lammps', adsorption_system, format='lammps-data')

print("Created adsorption system with ZnO nanoparticle and methane molecule")
